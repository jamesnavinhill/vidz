...
export default function Toolbar() {
  ...
  const isCollapsed = () => store.toolbarCollapsed || store.toolbarManualCollapsed;

  const toggleCollapsed = () => {
    setStore('toolbarManualCollapsed', !store.toolbarManualCollapsed);
    if (store.toolbarManualCollapsed) {
      setStore('toolbarCollapsed', false);
    }
  };
    ...
    >
      <button
        ...
        style={{
          ...
          color: '#aaa',
          cursor: 'pointer',
          'font-size': isCollapsed() ? '16px' : '14px',
          position: 'absolute',
          left: '50%',
